...
from database import Wishlist, db,migrate, BooksTesting, BookDetails, AuthorDetails
...
with app.app_context():
    ...
    try:
        ...
        author_dummy = AuthorDetails(author_fn = "Ted", author_ln = "Gioia", biography="Ted Gioia is an American jazz critic and music historian. He is author of eleven books",
                                     publisher = "Oxford University Press")

        db.session.add(author_dummy)
